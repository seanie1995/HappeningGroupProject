...
const FavoriteEventPopup = ({ event, onClose }) => {

    const eventDescription = htmlToText(event.description)

    const currentDate = new Date();

    const upcomingDates = event.date;
            ...
            <div className="bg-white rounded-lg shadow-lg max-w-xl w-full overflow-hidden">
                ...
                <div className="p-5">
                    ...
                    <div className="mt-3">
                        ...
                        <p className="text-sm text-gray-600">{eventDescription || "Ingen beskrivning tillgänglig."}</p>
                    </div>
...
export default FavoriteEventPopup;
